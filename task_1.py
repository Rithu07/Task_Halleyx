...
new_path ="\Users\subath\Documents\Coding\images" # add a path to folder where cropped faces are stored
...
def saveAndExit(event = 0):
    ...
    PATH = "\Users\subath\Documents\Coding\images"
    faces()
    original = cv2.imread("\Users\subath\Documents\Coding\images\0.jpg")
    duplicate = cv2.imread("\Users\subath\Documents\Coding\images\1.jpg")
